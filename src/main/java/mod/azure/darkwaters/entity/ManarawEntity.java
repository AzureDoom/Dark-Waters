...
public class ManarawEntity
    extends BaseWaterEntity implements IAnimatable, IAnimationTickable {

  private AnimationFactory factory = new AnimationFactory(this);

  public ManarawEntity(EntityType<? extends BaseWaterEntity> entityType,
                       World world) {
  ...
  public static DefaultAttributeContainer.Builder createMobAttributes() {
    return BaseWaterEntity.createMobAttributes()
        .add(EntityAttributes.GENERIC_MAX_HEALTH,
             DarkWatersConfig.manaraw_health)
        .add(EntityAttributes.GENERIC_ATTACK_DAMAGE,
             DarkWatersConfig.manaraw_attack_damage);
  }
  ...
  public void registerControllers(AnimationData data) {
    data.addAnimationController(new AnimationController<ManarawEntity>(
  ...
  protected SoundEvent getAmbientSound() {
    return r == 1 ? DarkWatersSounds.MANARAW_AMBIENT1
                  : DarkWatersSounds.MANARAW_AMBIENT2;
  }
